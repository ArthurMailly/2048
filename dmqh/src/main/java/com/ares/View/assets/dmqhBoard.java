...
public class dmqhBoard extends JPanel
{
    ...
    /**
     * Cette méthode permet de récupérer la taille du plateau de jeu.
     * @return int taille du plateau de jeu
     */
    ...
    /**
     * Cette méthode permet de mettre à jour le plateau de jeu. On commence par supprimer toutes les cases du plateau, afin de s'assurer qu'elle n'interfèrent pas avec les nouvelles cases.
     * On récupère ensuite les cases du plateau de jeu via le controller, et on les ajoute au plateau de jeu. 
     * Via une boucle for, on parcours chaque case du plateau, et on appelle la méthode removeAll() pour supprimer les éléments de la case, puis on ajoute les labels de la case via la méthode addLabels().
     * L'objet mis à jour est ensuite ajouté au plateau de jeu. Les ùéthode revalidate() et repaint() permettent de valider les changements et de les afficher.
     */
